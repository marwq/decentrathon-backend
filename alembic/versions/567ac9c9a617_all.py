...
Revision ID: 567ac9c9a617
Revises: 
Create Date: 2024-10-19 20:07:00.273153
...
def upgrade() -> None:
    ...
    sa.Column('work_searching_type', sa.Enum('ACTIVE_SEARCH', 'SEARCH', 'WORKING', 'FREELANCE', 'NO', name='worksearchingtype'), nullable=False),
